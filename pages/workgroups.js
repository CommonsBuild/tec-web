    ...
    return (
      <>
        ...
        <div className="w-full tec-bg-gradient-2">
          ...
          <div className="pb-0 text-xl text-left text-white px-7 lg:pb-7 tec-container sm:mx-auto font-extralight tec-wg-hero-body lg:text-2xl font-inter">
            <Markdown>{attributes.heroBody}</Markdown>
          </div>

          <div className="grid max-w-md grid-cols-1 gap-5 px-5 pb-16 mx-auto lg:px-0 lg:gap-x-10 lg:gap-y-10 md:max-w-4xl lg:max-w-5xl md:grid-cols-2">
